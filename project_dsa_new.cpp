...
void makedriverinfodelhi(){
    ...
    m1[0].push_back(d1);m1[0].push_back(d2);m1[0].push_back(d3);
    ...
    m1[1].push_back(d4);m1[1].push_back(d5);m1[1].push_back(d6);
    ...
    m1[6].push_back(s4);m1[6].push_back(s5);
    ...
    m1[8].push_back(s7);m1[8].push_back(s8);
    ...
    m1[9].push_back(h1);m1[9].push_back(h2);m1[9].push_back(h3);
    ...
    m1[10].push_back(g1);m1[10].push_back(g2);m1[10].push_back(g3);
...
void makedriverinfouk(){
    ...
    m2[0].push_back(d1);m2[0].push_back(d2);m2[0].push_back(d3);
    ...
    m2[1].push_back(d4);m2[1].push_back(d5);m2[1].push_back(d6);
    ...
    m2[6].push_back(s4);m2[6].push_back(s5);
    ...
    m2[8].push_back(s7);m2[8].push_back(s8);
    ...
    m2[9].push_back(h1);m2[9].push_back(h2);m2[9].push_back(h3);
    ...
    m2[10].push_back(g1);m2[10].push_back(g2);m2[10].push_back(g3);
...
void makedriverinfobg(){
    ...
    m3[0].push_back(d1);m3[0].push_back(d2);m3[0].push_back(d3);
    ...
    m3[1].push_back(d4);m3[1].push_back(d5);m3[1].push_back(d6);
    ...
    m3[6].push_back(s4);m3[6].push_back(s5);
    ...
    m3[8].push_back(s7);m3[8].push_back(s8);
    ...
    m3[9].push_back(h1);m3[9].push_back(h2);m3[9].push_back(h3);
    ...
    m3[10].push_back(g1);m3[10].push_back(g2);m3[10].push_back(g3);
...
/*void makepaththroughstops(int src,int des,vector<vector<edge>>graph,int nmv,unordered_map<string,int>getid,unordered_map<int,string>getcity){
    cout<<"ppppp"<<"\n";
    stops s11(src,0.0,0,(getcity[src]+"->"));
    priority_queue<stops,vector<stops>,greater<stops>>q1;
    q1.push(s11);
    ...
    while(!q1.empty()){
        ...
        stops s1=q1.top(); q1.pop();
        
        if(des==s1.node&&s1.bitmsk==(1<<nmv)-1){
            cout<<"total distance that you have to cover is "<<" - "<<s1.distance;
            cout<<"Path that you have to follow is\n"<<s1.path<<"\n";
            continue;
        }

        if(visited[s1.node]==true)
        continue;

        visited[s1.node]=true;

       

        for(int i=0;i<graph[s1.node].size();i++){

            edge e1=graph[s1.node][i];

            if(visited[e1.nbr]!=true){
                string city=getcity[e1.nbr];
                stops s2(0,0.0,0,"");
                s2.node=e1.nbr;
                s2.distance=s1.distance+e1.wt;
                s2.bitmsk=s1.bitmsk;
                s2.path=s1.path+city+"->";
                if(getid.find(city)!=getid.end()){
                    s2.bitmsk|=(1<<getid[city]);
                }
                q1.push(s2);
            }
        }
...
//nmv=number of nodes that must visit
...
void shortestPathcity(int src,vector<vector<edge>> &city,unordered_map<int,string>&getcity)
{
    ...
    priority_queue<prism,vector <prism>,greater<prism> > pq;
    prism d1(src,0);
    vector<bool>visited(city.size(),false);
    double count=0;
    int visit=0;
